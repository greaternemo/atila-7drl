...
/*
PLAY.Input.prototype.
*/

PLAY.Input.prototype.init = function () {
    // create the input buffer array
    SCON('INPUT_BUFFER', []);
    this.inputLoop = new PLAY.Loop(function () {
...
PLAY.Input.prototype.endCurrentInputContext = function () {
    // I think this might really be it for this
    GCON('INPUT_CONTEXT').shift();
};

/*
PLAY.Input.prototype.parseRawKeydown = function (rKey) {
...
PLAY.Input.prototype.queueInput = function (iStr) {
...
PLAY.Input.prototype.handleInput = function () {
...
PLAY.Input.prototype.pressButton = function (aButton) {
...
/*
PLAY.Input.prototype.NEWKEY = function () {
...
PLAY.Input.prototype.numpad1 = function () {
    // nothing
};

PLAY.Input.prototype.numpad2 = function () {
    // duplicate key
    // return SIG('keyarrowdown');
};

PLAY.Input.prototype.numpad3 = function () {
    // nothing
};

PLAY.Input.prototype.numpad4 = function () {
    // duplicate key
    // return SIG('keyarrowleft');
};

PLAY.Input.prototype.numpad5 = function () {
    // duplicate key
    // return SIG('keyspace');
};

PLAY.Input.prototype.numpad6 = function () {
    // duplicate key
    // return SIG('keyarrowright');
};

PLAY.Input.prototype.numpad7 = function () {
    // duplicate key
    // return SIG('keyescape');
};

PLAY.Input.prototype.numpad8 = function () {
    // duplicate key
    // return SIG('keyarrowup');
};

PLAY.Input.prototype.numpad9 = function () {
    // duplicate key
    // return SIG('keyf');
};

PLAY.Input.prototype.keyarrowup = function () {
    /*
    switch (GCON('INPUT_CONTEXT')[0]) {
        case 'movement':
            SIG('movePlayerNorth');
...
PLAY.Input.prototype.keyarrowright = function () {
    /*
    switch (GCON('INPUT_CONTEXT')[0]) {
        case 'movement':
            SIG('movePlayerEast');
...
PLAY.Input.prototype.keyarrowdown = function () {
    /*
    switch (GCON('INPUT_CONTEXT')[0]) {
        case 'movement':
            SIG('movePlayerSouth');
...
PLAY.Input.prototype.keyarrowleft = function () {
    /*
    switch (GCON('INPUT_CONTEXT')[0]) {
        case 'movement':
            SIG('movePlayerWest');
...
PLAY.Input.prototype.keyspace = function () {
    /*
    switch (GCON('INPUT_CONTEXT')[0]) {
        case 'movement':
...
PLAY.Input.prototype.keyescape = function () {
    /*
    switch (GCON('INPUT_CONTEXT')[0]) {
        case 'movement':
            // does nothing
...
PLAY.Input.prototype.keyf = function () {
    /*
    switch (GCON('INPUT_CONTEXT')[0]) {
        case 'movement':
            // switch to targeting
