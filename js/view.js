...
PLAY.View.prototype.init = function () {
    // then we build our view loop
    SCON('READY_TO_DRAW', true);
    this.viewLoop = new PLAY.Loop(function () {
        return SIG('drawNextLine');
    }, GCON('VIEW_LOOP_DELAY'));
};

PLAY.View.prototype.drawNextLine = function () {
    // we don't draw unless we're ready
    if (GCON('READY_TO_DRAW') === true &&
        GCON('GAME_PAUSED') === false) {
        SCON('READY_TO_DRAW', false);
        // we don't draw unless we have something to draw
        // console.log(GCON('LOG_QUEUE'));
        if (GCON('LOG_QUEUE').length > 0) {
            let updatedQueue = [...GCON('LOG_QUEUE')];
            let newLine = updatedQueue.shift();
            // console.log('newLine: ' + newLine);
            SIG('narrate', newLine);
            SCON('LOG_QUEUE', updatedQueue);
        }
...
PLAY.View.prototype.changeViewLoopDelay = function () {
    let vLoopDelay = GCON('VIEW_LOOP_DELAY');
    this.viewLoop.changeDelay(vLoopDelay);
};
...
// refactor this
/*
//PLAY.View.prototype.drawPhysMap = function () {
PLAY.View.prototype.drawNextLine = function () {
    // we don't draw unless we're ready
...
/* unneeded
PLAY.View.prototype.handleCellUpdates = function (params) {
...
*/
/* unneeded
PLAY.View.prototype.drawTileToMap = function (params) {
...
*/
/* unneeded
PLAY.View.prototype.addToDirtyLoad = function (params) {
...
*/
/* unneeded
PLAY.View.prototype.pushDirtyLoad = function () {
    let dirtyLoad = GCON('DIRTY_LOAD');
    let dirtyLocs = GCON('DIRTY_LOCS');
...
*/
/* unneeded
PLAY.View.prototype.addCursorAtLoc = function (aLoc) {
...
*/
/* unneeded
PLAY.View.prototype.delCursorAtLoc = function (aLoc) {
...
*/
/* unneeded
PLAY.View.prototype.tryToMoveCursorInDir = function (aDir) {
...
*/
/* unneeded
PLAY.View.prototype.moveCursorToLoc = function (aLoc) {
