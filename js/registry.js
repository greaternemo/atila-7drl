...
/*
PLAY.Registry.prototype
*/

PLAY.Registry.prototype.init = function () {
    // import schema
    // build our constants
...
PLAY.Registry.prototype.importSchema = function (pSchema) {
...
PLAY.Registry.prototype.registerEntity = function (newEnt) {
...
PLAY.Registry.prototype.generateUeid = function () {
    let temp;
    let newid;
    while (true) {
        temp = '' + Math.random();
...
PLAY.Registry.prototype.chaseDown = function (eid) {
...
PLAY.Registry.prototype.destroyEntity = function (eid) {
